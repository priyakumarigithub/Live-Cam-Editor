#Final Code for hand detection capture
...
# Add the text "Palm Capture" at the top
label = tk.Label(root, text="Palm Capture", font=("Perpetua Titling MT", 30), fg='white')
...
capture_frame.pack(side=tk.LEFT, padx=(5,0), pady=(0,5))
...
save_button.pack(padx=10,pady=(225,0))
